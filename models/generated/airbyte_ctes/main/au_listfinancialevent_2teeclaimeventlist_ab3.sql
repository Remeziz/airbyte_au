...
-- depends_on: {{ ref('au_listfinancialevent_2teeclaimeventlist_ab2') }}
select
    ...
    ]) }} as _airbyte_guaranteeclaimeventlist_hashid,
    tmp.*
from {{ ref('au_listfinancialevent_2teeclaimeventlist_ab2') }} tmp
