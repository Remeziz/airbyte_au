...
select
    ...
    _airbyte_rentaltransactioneventlist_hashid
from {{ ref('au_listfinancialevent_2nsactioneventlist_ab3') }}
-- rentaltransactioneventlist at AU_ListFinancialEvents/RentalTransactionEventList from {{ ref('au_listfinancialevents') }}
where 1 = 1
